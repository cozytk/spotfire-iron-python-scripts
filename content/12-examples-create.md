...
1. 문서 속성 `InventoryReport`(문자열)를 미리 만들어 둡니다 → [6.7 참조](06-api-map.html#67)
...
!!! note "검증 포인트"
    ...
    - 시각화 배치는 Spotfire가 자동으로 격자에 채웁니다. 개수가 12개 이하면 이것으로 충분합니다.
      **행/열을 정확히 지정하고 싶다면** `LayoutDefinition`을 쓰세요 →
      [예제 21](12-examples-create.html)에 사용법을 정리해 두었습니다.
...
예제는 여기까지입니다(24~27번은 9·10장에 있습니다). 다음 장에서 **실무 팁과 성능**을 정리합니다.
