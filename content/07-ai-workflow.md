...
**가장 효과가 큰 재료입니다.** 이 교안의 예제([8~11장](08-examples-bulk.html))나
...
[6장](06-api-map.html)의 객체 모델 구조나 [13장 치트시트](13-cheatsheet.html)의
...
□ 4. 안 되면 → 7.4 템플릿 + 그 예제를 재료로 붙여 AI에게 요청
□ 5. 7.5 체크리스트로 코드를 눈으로 검증
□ 6. 분석 파일 사본을 연다
