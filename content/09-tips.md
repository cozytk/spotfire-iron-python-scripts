...
!!! danger "스크립트 변경은 되돌아가지 않는 경우가 많습니다"
    ...
    **반드시 지킬 것:**
    ...
    2. 실행 전에 **예제 1(인벤토리)이나 예제 18(감사)** 로 현재 상태를 기록
...
5~8장 예제가 전부 이 형태입니다. 새 스크립트를 짤 때 그대로 베끼세요.
...
| Web Player에서만 실패 | Analyst 전용 API | 9.1 표 확인 |
